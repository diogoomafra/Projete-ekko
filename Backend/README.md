...
├── ai_analyzer.py           # 🧠 Sistema IA (12 parâmetros)
...
| Método | Endpoint | Descrição |
|--------|----------|-----------|
| GET | `/unity/analise-ia/{unity_id}` | Análise IA (12 parâmetros) |
